...
/**
 * The following defines are hand-coded and were not generated by libmei as the
 * ones in ./libmei/atttypes.h were. These are generated by hand either because
 * they regroup different types (e.g., data_STEMDIRECTION), because specific
